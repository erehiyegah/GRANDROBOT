...
TECHNO_IMG = "https://telegra.ph/file/8c635bb22db75fe695e16.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/assistenereh_bot")],
                                                                                   [InlineKeyboardButton(text="ADD ASSISTEN EREH BOT TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Yeah, Akhirnya aku online")
